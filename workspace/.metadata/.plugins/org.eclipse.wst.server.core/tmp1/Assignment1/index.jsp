	...
	<section class="sec">
		<table align="right" float="left">  
			<tr><tr>
				...
				<td><input type="text" name="sname" width="5px" onkeypress="return (event.charCode!=39)"><label>single quote (') is not accepted </label></td></tr>
				
				<tr><td>Address:</td>
				<td><textarea rows="4" cols="50" name="address" width="2px" onkeypress="return (event.charCode!=39)"></textarea><label>Field Should Not Include Single Colon( ' )</td></tr>
				
				<tr><td>Mobile Number: </td>
				<td><input type="text" name="mno" onkeypress="return (event.charCode > 47 && event.charCode < 58) || (event.charCode > 7 && event.charCode < 9)"><label>Alphabetic and Special Character Are Not Allowed</label></td></tr>
